...
* [📄 Diccionario.pdf](./docs/DiccionarioDatos.pdf) - *Pendiente*
* [📝 Diccionario.md](./docs/DiccionarioDatos.md) - *Pendiente*
...
* ✅ Ver archivo: [`README.md`](./README.md)

---

### 📚 Uso de GitHub Wikis
* [Wiki del Proyecto](https://github.com/UPT-FAING-EPIS/proyecto-si889-2025-i-u3-ticona-martinez-perez/wiki) - *Pendiente*
* Contiene:
...
### 📋 GitHub Projects
* ✅ Issues relacionados a tareas completas - *Pendiente*
